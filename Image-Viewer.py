...
print(root.maxsize(),root.winfo_geometry())
...
def show_files():
    ...
    global index
    global filename
    filename=filedialog.askopenfilename(initialdir="C:/Uesrs/rmaur/Desktop",title="select Image files",filetypes=(("PNG file",'*.png'),("JPG Files","*.jpg"),("All Files","*.*")))
...
my_image=ImageTk.PhotoImage(Image.open('C:/Users/rmaur/Desktop/python/GUI/image/sorry.jpg').resize((800,550),Image.ANTIALIAS))
...
lable_back=Button(root,text='<<',padx=20,pady=5,command=lambda :backward(index),font=('arial',10,'bold'),bd=5).grid(row=2,column=0,padx=5)
